    ...
    <div className="relative border rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 group">
      <Link href={`/product/${product.id}`} key={product.id}>
        ...
        <div className="px-4 pb-4 relative">
          ...
          <div className="absolute inset-0 bg-white bg-opacity-90 p-4 mb-4 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
